...
namespace Homecare.Migrations
{
    ...
    [Migration("20251227071420_modify Disease table")]
    partial class modifyDiseasetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiseasePatient", b =>
                {
                    b.Property<string>("DiseasesICD")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("patientsId")
                        .HasColumnType("int");

                    b.HasKey("DiseasesICD", "patientsId");
            ...
            modelBuilder.Entity("DiseasePatient", b =>
                {
                    b.HasOne("Homecare.Model.Disease", null)
                        .WithMany()
                        .HasForeignKey("DiseasesICD")
